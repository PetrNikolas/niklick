...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Versioned Full-Stack solution - API and SPA template for hipsters!'),
			_1: {ctor: '[]'}
		});
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Message":{"args":[],"tags":{"None":[]}}},"aliases":{},"message":"Main.Message"},"versions":{"elm":"0.18.0"}});
}
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-43bf5fa526bcdb7aaf52.js.map