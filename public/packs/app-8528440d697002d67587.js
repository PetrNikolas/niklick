...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Main__ = __webpack_require__(/*! ../Main */ 1);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  __WEBPACK_IMPORTED_MODULE_0__Main___default.a.Main.embed(target);
});
...
var _PetrNikolas$niklick$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _PetrNikolas$niklick$Main$update = F2(
	function (message, model) {
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _PetrNikolas$niklick$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Full-Stack Solution - Versioned API and SPA template for hipsters!'),
			_1: {ctor: '[]'}
		});
};
var _PetrNikolas$niklick$Main$Model = {};
var _PetrNikolas$niklick$Main$init = {ctor: '_Tuple2', _0: _PetrNikolas$niklick$Main$Model, _1: _elm_lang$core$Platform_Cmd$none};
var _PetrNikolas$niklick$Main$main = _elm_lang$html$Html$program(
	{init: _PetrNikolas$niklick$Main$init, view: _PetrNikolas$niklick$Main$view, update: _PetrNikolas$niklick$Main$update, subscriptions: _PetrNikolas$niklick$Main$subscriptions})();
var _PetrNikolas$niklick$Main$None = {ctor: 'None'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _PetrNikolas$niklick$Main$main !== 'undefined') {
    _PetrNikolas$niklick$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Message":{"args":[],"tags":{"None":[]}}},"aliases":{},"message":"Main.Message"},"versions":{"elm":"0.18.0"}});
}
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-8528440d697002d67587.js.map